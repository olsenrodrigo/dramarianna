    ...
    <div id="hero" className="relative min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div
          ...
          style={{
            background: "linear-gradient(135deg, #5B578F 0%, #7370B3 40%, #827ECC 100%)"
          }}
        />
        <div
          className="absolute inset-0"
          style={{ background: "linear-gradient(to right, rgba(91, 87, 143, 0.95), rgba(91, 87, 143, 0.7), rgba(91, 87, 143, 0.3))" }}
        />
      </div>
          ...
          >
            {[
              ...
              <div key={index} className="text-center">
                ...
                <div className="text-sm" style={{ color: "#FCF3EB" }}>{stat.label}</div>
              </div>
            ))}
          </motion.div>
        </div>
