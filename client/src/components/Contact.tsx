...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24" style={{ backgroundColor: "#EDE0D5" }}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="bg-white rounded-2xl p-6 shadow-sm border" style={{ borderColor: "rgba(130, 126, 204, 0.15)" }}>
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: "#FCF3EB" }}>
                  <MapPin className="w-5 h-5" style={{ color: "#827ECC" }} />
                </div>
                <div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border" style={{ borderColor: "rgba(130, 126, 204, 0.15)" }}>
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: "#FCF3EB" }}>
                  <Phone className="w-5 h-5" style={{ color: "#827ECC" }} />
                </div>
                <div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border" style={{ borderColor: "rgba(130, 126, 204, 0.15)" }}>
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center" style={{ backgroundColor: "#FCF3EB" }}>
                  <Mail className="w-5 h-5" style={{ color: "#827ECC" }} />
                </div>
                <div>
              ...
              {status === "success" ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                  ...
                  <button
                    ...
                    style={{ borderColor: "rgba(130, 126, 204, 0.3)", color: "#755751" }}
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        style={{ borderColor: "rgba(130, 126, 204, 0.3)" }}
