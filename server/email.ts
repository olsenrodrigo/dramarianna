 ...
 * Dra. Marianna não está verificado lá, então o padrão sai de `sintetiza.ai`
...
const REMETENTE_PADRAO = "Site Dra. Marianna Assumpção <nao-responda@sintetiza.ai>";
const DESTINO_PADRAO = "contato@dramariannaassumpcao.com.br";
